...
This tutorial contains key steps of flowSpy workflow, including how to build an FSPY object, how to run clustering and dimension reduction, how to build a [Minimum Spanning Tree](https://en.wikipedia.org/wiki/Minimum_spanning_tree) (MST) tree, how to run pseudotime and how to inference trajectory. It took about four minutes to run the complete analysis workflow with 12000 cells and 9 markers. 
