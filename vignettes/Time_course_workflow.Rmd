...
plotPieTree(fspy, cex.size = 5, size.by.cell.number = T, as.tree = T, root.id = 16) + 
  scale_fill_manual(values = c("#00599F", "#009900", "#FF3222", "#F4D31D", "#FF99FF","#7A06A0"))
...
fspy <- defLeafCells(fspy, leaf.cells = c(25,1), verbose = T)
...
plotHeatmap(fspy, downsize = 10000)
