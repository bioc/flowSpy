...
Highthroughput cell-based assays with flow cytometric signals enables ones to analyze multiple single-cell parameters and identify cellular populations. The package **flowSpy** provides tools for differential trajectory analysis and visualization of flow cytometry data. 



## 1 Introduction

The `flowSpy` package provides a toolkit for analyzing flow cytometry data. This vignette provides an overview of time courses flow cytometry data analysis workflow with `flowSpy`. `flowSpy` was developed to analyze cellular population and inference differential trajectory based on a series of algorithms. 
...
<img src="../man/figures/Workflow.png" align="middle" alt="Workflow of flowSpy" />
...
The datasets analyzed in this study are available from the GitHub repository (https://github.com/ytdai/flowSpy-dataset). It can be downloaded through [git](https://git-scm.com/) `git clone https://github.com/ytdai/flowSpy-dataset.git`, or via web page. 
...
fcs.file <- "../../flowSpy-dataset/flowSpy-dataset/D2.fcs"
...
<img src="../man/figures/flowVis-1.png" alt="flowVis of FSC-H and SSC-H" height=50% width=50% />
