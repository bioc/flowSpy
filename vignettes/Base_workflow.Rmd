...
ggsave(paste0("../../flowSpy-dataset/Fig/usecase1/marker.", i, ".pdf"), width = 10, height = 8)
}
...
p <- plotCluster(fspy, item.use = c("tSNE_1", "tSNE_2"), category = "numeric",
            size = 100, color.by = i, show.cluser.id = T, show.cluser.id.size = 100) + 
  scale_colour_gradientn(colors = c("#00599F", "#EEEEEE", "#FF3222"))
ggsave(paste0("../../flowSpy-dataset/Fig/usecase1/tsne.", i, ".pdf"), width = 10, height = 8)
}
